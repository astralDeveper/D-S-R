...
const page = () => {
  return (
    <>
      <div className='max-w-screen-2xl px-10 max-md:px-4 mx-auto mt-20 max-md:mt-[10%] '>
        ...
        <form className='flex flex-col items-center mt-14 w-[500px] max-md:mt-8 max-md:w-full mx-auto gap-6'>
          ...
          <div className='flex justify-between items-center w-full'>
            ...
            <Link href={''} className='text-[#E51A1A] font-semibold max-sm:text-sm'>Forgot Password?</Link>
          </div>
        ...
        <div className='text-center mt-10 font-medium md:text-lg '>Don’t have an account yet? <Link href={''} className='text-[#012555] font-semibold'>Sign up</Link></div>
      </div>
    </>
  )
}
