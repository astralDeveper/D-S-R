  ...
  return (
    <>
      <div className='max-w-screen-2xl px-10 max-md:px-4 mx-auto mt-20 max-md:mt-[10%] mb-10 max-sm:mb-[10%]'>
        <h2 className='text-5xl font-bold text-center  text-[#012555] w-[60%] mx-auto max-xl:w-full max-lg:text-2xl '>Get Started Today with Diamond Sports Recruiting!</h2>
        ...
        <form  className='grid grid-cols-2 mt-14 w-[1200px] max-xl:w-full max-md:mt-8 max-md:w-full mx-auto gap-10 max-sm:gap-6'>
          ...
          <div className='col-span-2 w-[50%] mx-auto max-sm:w-[80%]'>
            <button className='bg-[#012555] w-full hover:bg-[#012555ad] transition-all text-white p-2 px-6 text-xl font-medium rounded-lg max-xl:text-lg max-sm:text-sm max-sm:font-medium'>Join Diamond Sports Recruiting</button>
          </div>
        </form>
        

        <p className='text-lg mt-28 text-center max-md:text-sm max-md:mt-16'>By clicking "Join Diamond Sports Recruiting" you agree to be bound by our <span className='text-[#2E8EC3] cursor-pointer'>Terms of Service</span>, <span className='text-[#2E8EC3] cursor-pointer'>Privacy Policy</span>,  and <span className='text-[#2E8EC3] cursor-pointer'>EULA.</span></p>
      </div>
    </>
  )
}
